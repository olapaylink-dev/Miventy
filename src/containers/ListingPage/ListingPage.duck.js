...
export const SAVE_LIKES_REQUEST = 'app/ListingPage/SAVE_LIKES_REQUEST';
...
const listingPageReducer = (state = initialState, action = {}) => {
  ...
  switch (type) {
    ...
    case SAVE_LIKES_REQUEST:
      return { ...state, saveLikesInProgress: true, saveLikesError: null,saveLikesSuccess:false };
    case SAVE_LIKES_SUCCESS:
      return { ...state, saveLikesInProgress: false, saveLikesError: null, saveLikesSuccess:true };
...
export const saveLikesError = error => ({
  type: SAVE_LIKES_ERROR,
  error: true,
  payload: error,
});
...
export const saveLike = (listingId,userId) => (dispatch, getState, sdk) => {
  ...
  saveLikes({
    ...
    .catch(e => {
      dispatch(saveLikesError(storableError(e)));
    });
};
