          ...
          {isAuthenticated?
            <div className={css.flex_col}>
              <div className={css.center} onClick={handleShowNotiMenu}>
                <svg className={css.action_btn} width="17" height="21" viewBox="0 0 17 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                {notificationCounts > 0?
                  <span className={css.noti_count}>{notificationCounts}</span>
                :""}
                ...
                <div className={css.noti_menu_con}>
                  ...
                  <div className={css.icon_con}>
                     ...
                     {notifications !== undefined && notifications.length > 0?
                        ...
                        <>
                          ...
                          <span>{intl.formatMessage({ id: 'Topbar.noMsg' })}</span>
                        </>
                      }
                  ...
                  <NamedLink className={css.view_all} name="InboxPage" params={{tab:"orders"}}>
                    {intl.formatMessage({ id: 'Topbar.viewAll' })}
                  </NamedLink>
                </div>
              :""}
          ...
          {isAuthenticated?
            <div className={css.flex_col}>
              <div className={css.center} onClick={handleLoadInbox}>
                <svg className={css.action_btn} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                {msgCounts > 0?
                  <span className={css.noti_count}>{msgCounts}</span>
                :""}
                ...
                <div className={css.noti_menu_con}>
                  <div className={css.menu_title_con}>
                      <span>{intl.formatMessage({id:'Dashboard.inbox'})}</span>
                      <div className={css.count}>{msgCounts}</div>
                  </div>
                  <div className={css.rule}></div>
                  <div className={css.icon_con}>
