              ...
              <div className={classNames(css.flex_row,css.full_w)}>
                <NamedLink name="LandingPage">
                  ...
                  <span className={css.catering}>
                    <span className={css.item_list}>
                      <FormattedMessage id="SearchPage.itemList" />
                    </span> /
                  </span>
                </div>
              <div className={classNames(css.pg_header,css.full_w)}>
                  <span className={css.light_text}>
                  <FormattedMessage id="SearchPage.showing" /> {listings.length} <FormattedMessage id="SearchPage.resultsFor" /> </span> <FormattedMessage id="SearchPage.serviceNearYou" />
              </div>
