...
export const TEST_TRANSACTION_REQUEST = 'app/CheckoutPage/TEST_TRANSACTION_REQUEST';
export const TEST_TRANSACTION_SUCCESS = 'app/CheckoutPage/TEST_TRANSACTION_SUCCESS';
export const TEST_TRANSACTION_ERROR = 'app/CheckoutPage/TEST_TRANSACTION_ERROR';
...
export const LOAD_PAYMENT_METHOD_REQUEST = 'app/CheckoutPage/LOAD_PAYMENT_METHOD_REQUEST';
export const LOAD_PAYMENT_METHOD_SUCCESS = 'app/CheckoutPage/LOAD_PAYMENT_METHOD_SUCCESS';
export const LOAD_PAYMENT_METHOD_ERROR = 'app/CheckoutPage/LOAD_PAYMENT_METHOD_ERROR';
...
const initialState = {
  ...
  paymentMethodUrlInProgress: false,
  paymentMethodUrlError: null,
...
export default function checkoutPageReducer(state = initialState, action = {}) {
  ...
  switch (type) {
    ...
    case LOAD_PAYMENT_METHOD_REQUEST:
      return { ...state, paymentMethodUrlInProgress: true, paymentMethodUrlError: null };
    case LOAD_PAYMENT_METHOD_SUCCESS:
      return { ...state, paymentMethodUrlInProgress: false ,paymentMethodUrl:payload};
    case LOAD_PAYMENT_METHOD_ERROR:
      return { ...state, paymentMethodUrlInProgress: false, paymentMethodUrlError: payload };
...
export const loadOtherPaymentRequest = () => ({ type: LOAD_PAYMENT_METHOD_REQUEST });
export const loadOtherPaymentSuccess = (response) => ({ 
  type: LOAD_PAYMENT_METHOD_SUCCESS,
  payload: response.session.url,
 });

export const loadOtherPaymentError = e => ({
  type: LOAD_PAYMENT_METHOD_ERROR,
  error: true,
  payload: e,
});
...
export const testTransactionRequest = () => ({ type: TEST_TRANSACTION_REQUEST });

export const testTransactionSuccess = transaction => ({
  type: TEST_TRANSACTION_SUCCESS,
  payload: { transaction },
});

export const testTransactionError = e => ({
  type: TEST_TRANSACTION_ERROR,
  error: true,
  payload: e,
});
...
export const initiateTransaction = (tx) => (dispatch, getState, sdk) => {
  dispatch(speculateTransactionRequest());
  const {
    listing,attributes
  }=tx;
...
export const loadOtherPaymentMethodUrl = (data) => (dispatch, getState, sdk) => {
  ...
  fetch('/api/payment-method', {
    ...
    .then(async (dat) => {
      ...
      dispatch(loadOtherPaymentError());
  })
