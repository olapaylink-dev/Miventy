...
import { DatePicker } from '../../examples';
import SearchMapNew from './SearchMapNew';
...
import NotificationUpdate from './NotificationUpdated';
import RemoveAccountDialogue from './RemoveAccountDialogue';
import ListingMainForm from './ListingForms/ListingMainForm';
import OngoingPrders from './OngoingOrders';
...
import { closeListing, getCurrentListing, requestCreateListingDraft, requestImageUpload, requestPublishListingDraft, requestShowListing, requestUpdateListing } from '../EditListingPage/EditListingPage.duck';
...
export const DashboardPageComponent = props => {
  ...
  return (
    ...
    >
      ...
      <div className={css.main_con}>
        ...
        <div className={css.container}>
            <div className={classNames(css.aside,css.desktop)}>
                <div onClick={showDashboard} className={css.flex_row}>
            ...
            {showSideNav?
              <>
                  <div className={css.overlay} onClick={e=>setshowSideNav(false)}>
                  
                  </div>
                  <div className={classNames(css.aside,css.mobile)}>
                      <div onClick={showDashboard} className={css.flex_row}>
                          <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <path fill-rule="evenodd" clip-rule="evenodd" d="M3.33333 9.58333C2.18274 9.58333 1.25 8.65059 1.25 7.5V3.33333C1.25 2.18274 2.18274 1.25 3.33333 1.25H7.5C8.65059 1.25 9.58333 2.18274 9.58333 3.33333V7.5C9.58333 8.65059 8.65059 9.58333 7.5 9.58333H3.33333ZM2.91667 7.5C2.91667 7.73012 3.10321 7.91667 3.33333 7.91667L7.5 7.91667C7.73012 7.91667 7.91667 7.73012 7.91667 7.5V3.33333C7.91667 3.10322 7.73012 2.91667 7.5 2.91667L3.33333 2.91667C3.10321 2.91667 2.91667 3.10322 2.91667 3.33333L2.91667 7.5Z" fill="black"/>
                              <path fill-rule="evenodd" clip-rule="evenodd" d="M1.25 16.6667C1.25 17.8173 2.18274 18.75 3.33333 18.75H7.5C8.65059 18.75 9.58333 17.8173 9.58333 16.6667V12.5C9.58333 11.3494 8.65059 10.4167 7.5 10.4167H3.33333C2.18274 10.4167 1.25 11.3494 1.25 12.5V16.6667ZM3.33333 17.0833C3.10321 17.0833 2.91667 16.8968 2.91667 16.6667L2.91667 12.5C2.91667 12.2699 3.10321 12.0833 3.33333 12.0833H7.5C7.73012 12.0833 7.91667 12.2699 7.91667 12.5V16.6667C7.91667 16.8968 7.73012 17.0833 7.5 17.0833H3.33333Z" fill="black"/>
                  ...
                  <div className={css.profile_photo}>
                     ...
                     <div className={css.open_con} onClick={e=>setshowSideNav(true)}>
                      ...
                      {imageSrcProfile !== undefined && imageSrcProfile !== null?
                        <img className={css.profilePhoto} onClick={handleProfileClick} src={imageSrcProfile}/>
                        :
                        <svg className={css.profilePhoto} onClick={handleProfileClick}  width="121" height="120" viewBox="0 0 121 120" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            {currentTab === "notificationSettings"?
             ...
             {currentTab === "listings"?
                <div >
                    ...
                    <div className={css.flex_title}>


                        <div className={css.mylisting_card_2}>
                          <button onClick={showDashboard} className={css.back_to_dashboard}>
    ...
    {showManagePayoutOptions?
      <div onClick={setShowManagePayoutOptions(false)} className={css.overlay}>
        <div className={css.formContent}>
          <div className={css.header_con}>
            ...
            <div className={css.close_btn}>
              <svg onClick={handleClose} className={css.close} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
          ...
          <div onClick={e=>{handleAddOption(e,"ApplePay")}} className={css.pay_options}>
           ...
           <div onClick={e=>{handleAddOption(e,"GooglePay")}} className={css.pay_options}>
           ...
           <div onClick={e=>{handleAddOption(e,"Paypal")}} className={css.pay_options}>
           ...
           <div onClick={e=>{handleAddOption(e,"BankTransfer")}} className={css.pay_options}>
    ...
    {activePayoutOption === "ApplePay"?
      <div onClick={setActivePayoutOption("")} className={css.overlay}>
        <div className={css.formContent}>
...
useEffect(()=>{
  ...
  return (
          <div className={css.overlay}>
                ...
                <div className={css.modal_complete_profile}>
                    ...
                    <form>
                      ...
                      <FormControl className={css.full_w}>
                        ...
                        >
                          <FormControlLabel className={css.no_spacing} value="businessOwner" control={
                            <Radio 
                              sx={{
                                  color: "#F56630",
                                  '&.Mui-checked': {
...
const handleSubmit = e=>{
  ...
  return (
          <div className={css.overlay}>
                ...
                <div className={css.modal_complete_profile_2}>
                  <div className={css.close_btn} onClick={e=>setCurrentPage("")}>
          ...
          <div className={css.overlay}>
                ...
                <div className={css.modal_complete_profile_busi}>
                  ...
                  <div className={classNames(css.flex_col,css.full_w)}>
                    ...
                    <FormControl className={classNames(css.full_w,css.form_input)}>
                      <label className={css.labels} for={"outlined-controlled"}>Address</label>
                      <input
                        id="outlined-controlled"
                        value={address}
                        onChange={(event) => {
                      ...
                      />
                      <label className={css.labels} for={"outlined-controlled"}>City</label>
                      <input
                        id="outlined-controlled"
                        value={city}
                        onChange={(event) => {
                          ...
                          {serviceAreas !== undefined && serviceAreas.map((itm,k)=>{
                                return (
                                  <div className={css.loca_con}>
                                    ...
                                    <svg onClick={e=>{handleRemove(itm.result.id)}} className={css.remove} xmlns="http://www.w3.org/2000/svg" width="16" height="17" viewBox="0 0 16 17" fill="none">
...
if(currentSelectedUserType === "businessOwner"){
  ...
  return (
          <div className={css.overlay}>
                ...
                <div className={css.modal_complete_profile_busi}>
                  <div className={classNames(css.flex_col_success,css.full_w)}>
