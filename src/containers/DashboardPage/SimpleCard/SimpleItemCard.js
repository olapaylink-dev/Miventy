...
const SimpleItemCard = props=>{
    const {catalogDetails,handleEditCatalog,handleDeletePriceDuration} = props;
    ...
    return (
        <div className={css.container} onClick={e=>{handleEditCatalog(catalogDetails)}}>
            ...
            <div className={css.flex_row}>
                <span className={css.price}>€{ItemPrice} - {duration} {format}</span><div className={css.view_all}>View All</div>
            </div>
                ...
                return (
                    <div className={css.duration_price}>
                        ...
                        <div className={css.flex_row_btw}>
                            ...
                            <button className={css.delete_btn_2} onClick={e=>handleDeletePriceDuration(durationPrice,itm,catalogDetails)}>Delete</button>
                        </div>
                    </div>
                )
            })}
