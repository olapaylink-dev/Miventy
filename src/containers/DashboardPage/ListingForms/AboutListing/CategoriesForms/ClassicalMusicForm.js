...
const ClassicalMusicForm = props =>{
    ...
    const serviceTypes = [
      intl.formatMessage({id: 'CategoriesForm.vocalist',}),
      intl.formatMessage({id: 'CategoriesForm.instrumental',}),
     ...
     intl.formatMessage({id: 'CategoriesForm.ukulele',}),
      intl.formatMessage({id: 'CategoriesForm.flute',}),
     intl.formatMessage({id: 'CategoriesForm.trumpet',}),
     intl.formatMessage({id: 'CategoriesForm.accordion',}),
     intl.formatMessage({id: 'CategoriesForm.piano',})
    ];
   ...
   const ServiceStandards = [
    ...
    const EquipmentProvided = [
      intl.formatMessage({id: 'CategoriesForm.paSystem',})
    ];
        ...
        <div className={css.formContent}>
          ...
          <form className={css.container} onSubmit={handleSubmit}>
                ...
                <div>
                 ...
                 <div>
                  <h1 className={css.header_2}>{intl.formatMessage({id: 'CategoriesForm.musicalInstrument',})}</h1>
                  <div className={css.check_con}>
