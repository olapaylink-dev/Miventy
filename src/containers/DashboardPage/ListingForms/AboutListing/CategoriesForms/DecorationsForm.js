...
const DecorationsForm = props =>{
  const intl = useIntl();
    ...
    const {publicData={},price}= currentListing !== undefined && currentListing.hasOwnProperty("attributes")?currentListing?.attributes:{};
    ...
    const isReady = !serviceType || !serviceStandards || !equipmentProvided || !pricee   || !minDuration || !maxDuration;

    const serviceTypes = [
      intl.formatMessage({id: 'CategoriesForm.flowerDeco',}),
      intl.formatMessage({id: 'CategoriesForm.balloonDeco',}),
    ...
    const EquipmentProvided = [
     intl.formatMessage({id: 'CategoriesForm.tables',}),
      intl.formatMessage({id: 'CategoriesForm.chairs',}),
      intl.formatMessage({id: 'CategoriesForm.cutlery',}),
      intl.formatMessage({id: 'CategoriesForm.tableLinens',}),
     intl.formatMessage({id: 'CategoriesForm.partyTents',})
    ];
