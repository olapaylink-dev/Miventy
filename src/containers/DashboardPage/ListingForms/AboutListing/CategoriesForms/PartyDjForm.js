...
const PartyDjForm = props =>{
    ...
    const isReady = !equipmentProvided || !serviceStandards || !pricee   || !minDuration || !maxDuration;
    ...
    const EquipmentProvided = [
      intl.formatMessage({id: 'CategoriesForm.pa',}),
      intl.formatMessage({id: 'CategoriesForm.lighting',}),
      intl.formatMessage({id: 'CategoriesForm.smokeMachine',}),
      intl.formatMessage({id: 'CategoriesForm.screens',}),
      intl.formatMessage({id: 'CategoriesForm.microphones',})
