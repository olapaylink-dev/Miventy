...
const routeConfiguration = (layoutConfig, accessControlConfig) => {
  ...
  return [
    ...
    },
    {
     ...
     {
      path: '/l/:slug/:id/checkout_transaction',
      name: 'CheckoutTransactionPage',
      auth: true,
      component: CheckoutPage,
      setInitialValues: pageDataLoadingAPI.CheckoutPage.setInitialValues,
    },
    ...
    {
      path: '/profile-settings/catalog/start',
      name: 'ProfileSettingsStartCatalogPage',
      auth: true,
      authPage: 'LoginPage',
      component: DashboardPage,
      loadData: (pageDataLoadingAPI.DashboardPage.loadData),
     ...
     {
      path: '/profile-settings/catalog/new/:id',
      name: 'ProfileSettingsCreateCatalogPage',
      auth: true,
      authPage: 'LoginPage',
      component: DashboardPage,
      loadData: (pageDataLoadingAPI.DashboardPage.loadData),
    ...
    {
      path: '/profile-settings/catalog/edit/:id',
      name: 'ProfileSettingsEditCatalogPage',
      auth: true,
      authPage: 'LoginPage',
      component: DashboardPage,
      loadData: (pageDataLoadingAPI.DashboardPage.loadData),
     ...
     {
      path: '/profile-settings/catalog',
      name: 'ProfileSettingsCatalogListPage',
      auth: true,
      authPage: 'LoginPage',
      component: DashboardPage,
      loadData: (pageDataLoadingAPI.DashboardPage.loadData),
    ...
    {
      path: '/profile-settings/dashboard',
      name: 'ProfileSettingsPage',
      auth: true,
      authPage: 'LoginPage',
      component: DashboardPage,
    ...
    {
      path: '/l/:id/:slug',
      name: 'ProfileSettingsPageEditListing',
      auth: true,
      component: EditListingPage,
      loadData: pageDataLoadingAPI.EditListingPage.loadData,
    },
    ...
    {
      path: '/inbox/:tab/bookings',
      name: 'InboxOrderViewPage',
      auth: true,
      authPage: 'LoginPage',
      component: InboxPage,
      loadData: pageDataLoadingAPI.InboxPage.loadData,
    ...
    {
      path: '/:id/:status/success',
      name: 'PaymentMethodResponsePage',
      auth: true,
      component: PaymentMethodResponsePage,
    },
    {
