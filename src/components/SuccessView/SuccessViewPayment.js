...
const SuccessViewPayment = props=>{
  const intl = useIntl();
  ...
  return (
                <div className={css.modal_complete_profile_busi}>
                  <div className={classNames(css.flex_col)}>
                    ...
                    <NamedLink className={css.back_btn} name="InboxPage" params={{tab:"sales"}}>{intl.formatMessage({id: 'Dashboard.continueToInbox',})}</NamedLink>
                  </div>
...
export default SuccessViewPayment;