...
export default class MyDatePicker extends Component {
    ...
    constructor() {
        ...
        this.state = {
            year,
            month,
            // selectedDay: this.props !== undefined && this.props.hasOwnProperty("currentDate") && this.props.currentDate !== undefined && this.props.currentDate !== null? this.props.currentDate : todayTimestamp ,
            ...
            return (
                <div className={'c-day-container ' + (day.month !== 0 ? ' disabled' : '') + 
                    ...
                    <div className='cdc-day'>
                        <span onClick={(e)=>{this.onDateClick(day); e.preventDefault(); e.stopPropagation();}}>
                            {day.date}
                        </span>
                    </div>
                </div>
    ...
    render() {
        return (
            <div className='MyDatePicker' onClick={e=>{e.preventDefault(); e.stopPropagation();}}>
                <div className='mdp-input'  onClick={(e)=> {this.props.setShowDatePicker(true);}}>
