    ...
    return (
            <div className={css.modal}>
                <div className={css.container_header}>
                    <h2>{intl.formatMessage({id: 'Dashboard.quoteAcceptedReady',})}</h2>
                ...
                <p className={css.sub_header}>
                   {intl.formatMessage({id: 'Dashboard.youHaveAcceptedThe',})} 
                </p>
