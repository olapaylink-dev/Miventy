    ...
    return             (
        <div onClick={e=>{e.preventDefault(); e.stopPropagation(); setShow(!show);}} className={css.container}>
            <div className={css.flex_row}>
                <span>{intl.formatMessage({ id: `CustomSelect.sortBy` })}:</span>
                <div className={css.label} >
                    <span >{currOption !== ""?intl.formatMessage({ id: `CustomSelect.${currOption}` }):  intl.formatMessage({ id: 'CustomSelect.recentlyAdded' }) } </span>
                    ...
                    <FormControl className={css.full_w}>
                        ...
                        >
                            ...
                            return(
                                ...
                                label={intl.formatMessage({ id: `CustomSelect.${option}` })} 
                                />
                                )
