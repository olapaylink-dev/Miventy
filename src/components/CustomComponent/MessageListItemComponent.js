...
export default function MessageListItemComponent(props){
    const {transactions,currentUser,handleShowTransactionDetails,onfetchMessage,currentTransaction,handleDeleteChat,deletedChat} = props;
                    ...
                    <div key={`messageList_${key+1}`} className={itm?.id?.uuid === currentTransaction?.id?.uuid?css.container_active: css.container} onClick={e=>handleShowTransactionDetails(itm,displayName,imgUrl,isProvider)}>
                        ...
                        <div className={css.flex_col}>
                            <div className={css.flex_row_2}>
                                ...
                                {/* <svg onClick={e=>setShowDelete(!showDelete)} className={css.options} xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 4 25" fill="none">
                                ...
                                <svg className={css.delete} onClick={e=>{handleDeleteChat(id)}} xmlns="http://www.w3.org/2000/svg" width="21" height="20" viewBox="0 0 21 20" fill="none">
