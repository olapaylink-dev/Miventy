...
const ALLOrders = props =>{
    ...
    // const listingId = orders?.listing?.id?.uuid;
    // const slug = orders?.listing?.attributes?.title;
    // localStorage.setItem("Transaction",JSON.stringify(orders));
    ...
    // const isPaid = checkIfPaid(orders);
