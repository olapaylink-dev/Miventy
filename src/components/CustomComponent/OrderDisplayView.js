    ...
    return (
            <div className={css.modal}>
                <div className={css.container_header}>
                    <h2>{intl.formatMessage({ id: `OrderDisplayView.orderDetails` })}</h2>
                ...
                <h3 className={css.sub_header}>{listingType} {intl.formatMessage({ id: `OrderDisplayView.service` })}</h3>
                
                <div className={css.container}>
                        <>
                            <div className={css.flex_col}> 
                                
                                <h3 className={css.sub_header_2}>{intl.formatMessage({ id: `OrderDisplayView.catalogOrder` })}</h3>
                                ...
                                :
                                    ...
                                    <OfferItems
                                        ...
                                        message={
                                            isProvider?
                                            intl.formatMessage({ id: `OrderDisplayView.theOrderDoesNotHaveItems` })
                                            :
                                            intl.formatMessage({ id: `OrderDisplayView.youDidNotAddAnyItem` })
                                        }
                                ...
                                <div className={css.grid_con}>
                                    <div>
                                        <div className={css.flex_row_2}>
                                           ...
                                           {intl.formatMessage({ id: `OrderDisplayView.date` })}
                                        </div>
                                        <p>{eventDate}</p>
                                    </div>
                                    <div>
                                        ...
                                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                           ...
                                           {intl.formatMessage({ id: `OrderDisplayView.time` })}
                                        </div>
                                        <p>{intl.formatMessage({ id: `ListingPage.${duration}` })}</p>
                                    </div>
                                     ...
                                     <div>
                                        <div className={css.flex_row_2}>
                                          ...
                                          {intl.formatMessage({ id: `OrderDisplayView.location` })}
                                        </div>
                                    ...
                                    <div>
                                        <div className={css.flex_row_2}>
                                           ...
                                           {intl.formatMessage({ id: `OrderDisplayView.guests` })}
                                        </div>
                                        <p>{intl.formatMessage({ id: `ListingPage.${guestCount}` })}</p>
                                    </div>
                                </div>
                                {selectedServiceType !== undefined && selectedServiceType !== null && selectedServiceType !== ""?
                                    <div>
                                        <div className={css.flex_row_2}>
                                           {intl.formatMessage({ id: `OrderDisplayView.menuType` })}
                                        </div>
                                ...
                                <>
                                    ...
                                    (
                                        ...
                                        transactionState === "state/accepted" || transactionState === "state/accept"?
                                           intl.formatMessage({ id: `OrderDisplayView.youHaveAcceptedThisOffer` })
                                        :isOrderDeclined?
                                            <span className={css.declined_txt}>{intl.formatMessage({ id: `OrderDisplayView.youHaveDeclinedThisOffer` })}</span>
                                        :
                                        <div className={css.flex_row}>
                                            <button className={css.btn_outline} onClick={handleDeclineOffer}>
                                               {intl.formatMessage({ id: `OrderDisplayView.decline` })} 
                                            </button>
                                            <button className={css.btn_fill} 
                                                onClick={e=>{
                                                        onAcceptOfferFromCustomer(currentTransaction,intl.formatMessage({ id: `OrderDisplayView.offerWasAccepted` }));
                                                    }}>
                                               {intl.formatMessage({ id: `OrderDisplayView.accept` })}
                                            </button>
                                        </div>
                                    )
                                        ...
                                        <div className={css.flex_row}>
                                            ...
                                            <button className={css.btn_fill} onClick={e=>{setShowQuotationForm(true); setShowOrder(false)}}>
                                              {intl.formatMessage({ id: `OrderDisplayView.createAQuote` })}  
                                            </button>
                                        </div>
                                    }
                                </>
