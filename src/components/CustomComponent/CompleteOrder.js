...
import css from './CompleteOrder.module.css';
    ...
    return (
            <div className={css.modal}>
                <div className={css.container_header}>
                    ...
                    <svg onClick={e=>setShowCompleteOrder(false)} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                ...
                <p className={css.sub_header}>
                   Your order has been completed and the service provider has been notified.
                    Please leave a review about your service experience. This will be made public.
                </p>
                ...
                <div className={css.container}>
                    ...
                    {!isProvider && !isOwn?
                        <div className={css.flex_row}>
                            <button className={css.btn_outline} onClick={e=>setShowCompleteOrder(false)}>
                                Skip for now
                            </button>
                            <button className={css.btn_fill} onClick={e=>{setShowRatingForm(true);setShowCompleteOrder(false)}}>
                                Add a review
                            </button>
                        </div>
                    :""}
