...
const MessageListItem = props =>{
    ...
    return(
                    ...
                    onClick={e=>{handleShowTransactionDetails(itm,displayName,imgUrl,isProvider);setShowAside(false)}}
                    >
                        <img className={css.profile_img} alt='Profile image' src={imgUrl} />
                        <div className={css.flex_col}>
                            <div onMouseOver={e=>setShowDelete(true)} onMouseOut={e=>setShowDelete(false)} className={css.flex_row_2}>
                                <span className={css.title}>{displayName}</span>
                                {showDelete?
                                    <svg className={css.delete} onClick={e=>{handleDeleteChat(customer.id.uuid,provider.id.uuid,id)}} xmlns="http://www.w3.org/2000/svg" width="21" height="20" viewBox="0 0 21 20" fill="none">
                                    ...
                                    :
                                    <svg className={css.options} xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 4 25" fill="none">
