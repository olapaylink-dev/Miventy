                ...
                <div className={css.container}>
                    <div className={css.flex_col}>
                        ...
                        <div className={css.area_con} onClick={e=>setShowMap(true)}>
                            ...
                            <div className={css.flex_row_area}>
                                ...
                                :
                                <>
                                    <span className={css.placeholder}>Select your service area from the map</span>
                    ...
                    <div className={css.flex_col}>
                        ...
                        <div className={css.area_con}>
                            ...
                            <input onChange={e=>setEventDate(e.target.value)} type="date" placeholder="Type in or select date from calendar"/>
                        </div>
                    </div>
