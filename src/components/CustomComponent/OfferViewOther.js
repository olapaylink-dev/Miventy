...
import css from './OfferViewOther.module.css';

// File updated
const OfferViewOther = (props)=>{
    const {trx,isProvider,
        ...
        <div className={css.main_com}>
            <div className={css.container}>
                ...
                <div className={css.message}>
                    ...
                    <p>The service provider has sent a quote, view to accept or decline/adjust the quote</p>
