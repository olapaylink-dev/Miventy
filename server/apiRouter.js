...
const sendSMSCallback = require('./api/send-sms');
const updateTransaction = require('./api/transaction-update');
const createOffer = require('./api/create-offer-listing');
const paymentMethod = require('./api/payment-method');
...
router.post('/send-sms', sendSMSCallback);
